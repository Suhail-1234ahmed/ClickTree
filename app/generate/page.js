                ...
                <div className='flex flex-col gap-5 my-8'>
                    ...
                    <div className="item">
                        ...
                        <div className='mx-4 flex flex-col'>
                            ...
                            <button onClick={submitLinks} className='disabled:bg-slate-500 p-5 py-2 mx-2 w-fit my-5 bg-slate-900 text-white font-bold rounded-3xl'>Create your ClickTree</button>
                        </div>
                    </div>
                </div>
            </div>
